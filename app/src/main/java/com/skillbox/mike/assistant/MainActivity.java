...
public class MainActivity extends AppCompatActivity {
    ...
    protected String answerQuestion(String question, Map<String, String> questions) {
        ...
        if (question.contains("какой сегодня день")) { // Отдельно предусмотрим случай, когда пользователь спрашивает день
            DateFormat fmt = new SimpleDateFormat("EEEE, d.M.yyyy"); // Создадим объект для форматирования даты/времени
            String time = fmt.format(new Date()); // Отформатируем текущую дату
